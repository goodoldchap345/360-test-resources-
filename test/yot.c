...
void set_data(Channel *channel)
{
    ...
    Channel *channel_thing = (Channel*) channel;

    sem_wait(&channel_thing->write);
...
void init_channel(Channel *channel)
{
    ...
    Channel *channel_thing = (Channel*) channel;
    sem_init(&channel_thing->read, 0, 0);
    ...
    // place your code between the lines of //
    ///////////////////////////////////////////////
    sem_init(&channel_thing->write, 0, 1);
